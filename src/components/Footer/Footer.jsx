  ...
  return (
    <footer className='flex flex-col items-center'>
      ...
      <div className='grid grid-cols-2 w-2/12'>
        <a
          href='https://github.com/andersonvilla/ '
          target='_blank'
          rel='noreferrer'
        >
          <img
            src={git}
            alt='git'
            className='mr-6 mt-2 md:w-8/12 lg:w-2/5 lg:ml-10'
          />
        </a>
        <a
          href='https://www.linkedin.com/in/anderson-villa-sierra-92776a213/'
          target='_blank'
          rel='noreferrer'
        >
          <img
            src={linkedin}
            alt='linkedin'
            className='ml-6 mt-2 md:w-8/12 lg:w-2/5'
          />
        </a>
      </div>
