...
const Academic = () => {
    return (
      <div className='justify-center m-4'>
        ...
        <h3 className='font-semibold text-[#57C8B4] text-center lg:text-lg'>Información Académica</h3>
        <div className='m-3'>
          <h3 className='font-semibold'>Ingeniería de Sistemas| Febrero 2017 - Actualidad</h3>
          <span className='text-sm'>Universidad de Antioquia<br/></span>
          ...
          <span className='text-sm'>Institución Educativa La Gabriela</span>
        </div>
